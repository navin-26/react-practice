...
const CarouselV = () => {
  ...
  return (
    <div className="flex flex-col gap-12 top-[158px]">
      <div className="flex flex-col justify-start text-start gap-3 w-[600px] h-[10.5rem]">
        <h6 className="text-[2.625rem] font-semibold">
          {slides[currentIndex].h1}
        </h6>
        <p className="text-[1.375rem]">{slides[currentIndex].p1}</p>
      </div>
      <div className="flex flex-row gap-x-10">
        <div className="flex flex-col justify-start  text-start gap-5 h-[11.625rem] w-[16.938rem]">
          ...
          <p className="text-[1rem]">{slides[currentIndex].c1p}</p>
        </div>
        <div className="flex flex-col justify-start w-1/2 text-start gap-5">
          ...
          <p className="text-[1rem]">{slides[currentIndex].c2p}</p>
        </div>
      </div>
