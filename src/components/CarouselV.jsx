...
import { faClone, faGem } from "@fortawesome/free-regular-svg-icons";
  ...
  return (
    <div className="lg:flex flex-row gap-12 lg:w-[500px] max-lg:justify-center">
      <div className="xl:ml-[510px] lg:ml-[350px] flex flex-col lg:items-center">
        <div className="flex flex-col text-start gap-3 xl:w-[600px] lg:w-[600px] sm:w-auto h-[10.5rem] max-lg:text-center">
        ...
        <div className="lg:grid grid-cols-2 mt-10 max-lg:hidden">
          <div className="flex flex-col text-start gap-5 h-[11.625rem] w-[16.938rem]">
            <FontAwesomeIcon
              className="h-8 w-8"
